    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-muted-foreground">Loading thoughts...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {posts.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-bold text-gray-800 dark:text-foreground mb-2">No thoughts yet</h3>
              <p className="text-gray-600 dark:text-muted-foreground">Check back soon for new reflections and insights!</p>
            </div>
          )}
        </div>
      </section>
