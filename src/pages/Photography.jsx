      ...
      <div>
        <section className="banner-transparent py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="banner-text text-4xl md:text-5xl font-bold mb-4">{settings?.tagline || "Captured Moments"}</h1>
            <p className="banner-text-secondary text-xl">{settings?.message || "Visual stories through the lens of my camera."}</p>
          </div>
        </section>
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            {posts.length > 0 ? (
              ...
              <div className="text-center py-16"><div className="text-6xl mb-4">📸</div><h3 className="text-2xl font-bold text-gray-800 dark:text-foreground mb-2">No photography yet</h3><p className="text-gray-600 dark:text-muted-foreground">Check back soon for new photos!</p></div>
            )}
          </div>
        </section>
      </div>
